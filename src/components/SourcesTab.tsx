...
export const SourcesTab = () => {
  ...
  return (
    <div className="p-4 md:p-10 bg-[#F5F4F0] h-full overflow-y-auto pb-24 md:pb-10">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 md:mb-10 gap-4">
        ...
        <div className="flex flex-wrap gap-3 w-full md:w-auto">
          ...
          <button 
            ...
            className="bg-[#1A1A1A] text-white px-4 md:px-6 py-2.5 rounded-xl text-xs md:text-sm font-bold flex items-center gap-2 hover:bg-black transition-all"
          >
            <Plus size={18} /> Nouvelle
          </button>
          <button 
            onClick={() => fileInputRef.current?.click()}
            className="bg-[#008080] text-white px-4 md:px-6 py-2.5 rounded-xl text-xs md:text-sm font-bold flex items-center gap-2 hover:bg-[#006666] transition-all shadow-lg shadow-[#008080]/20"
          >
      ...
      <div 
        onClick={() => fileInputRef.current?.click()}
        className="bg-white border-2 border-dashed border-[#E8E5E0] rounded-[24px] md:rounded-[40px] p-8 md:p-16 text-center mb-8 md:mb-12 group hover:border-[#008080] transition-all cursor-pointer"
      >
        ...
        <p className="text-xs md:text-sm text-gray-400 font-medium max-w-xs mx-auto">PDF, DOCX, BibTeX ou RIS. Vos sources seront indexées par l&apos;IA pour vos recherches.</p>
      </div>
